...
var hexagonGC = 0, heptagonGC = 0, octagonGC = 0
...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        authenticatePlayer()
        loadGCScore(id: "hexagon")
        loadGCScore(id: "heptagon")
        loadGCScore(id: "octagon")
    ...
    func createAndLoadBanner() {
        ...
        bannerAd.adUnitID = "ca-app-pub-6416730604045860/6631222509" //"ca-app-pub-3940256099942544/2934735716" // for test ads
    ...
    func createAndLoadInterstitial() {
        interstitialAd = GADInterstitial(adUnitID: "ca-app-pub-6416730604045860/8107955706") // "ca-app-pub-3940256099942544/4411468910") // for test ads
    ...
    func loadGCScore(id: String) {
        let leaderboardRequest = GKLeaderboard()
        leaderboardRequest.identifier = id
        leaderboardRequest.loadScores { (scores, error) -> Void in
            if error != nil {
                ...
                if id == "hexagon" {
                    hexagonGC = Int(leaderboardScore)
                }
                else if id == "heptagon" {
                    heptagonGC = Int(leaderboardScore)
                }
                else if id == "octagon" {
                    octagonGC = Int(leaderboardScore)
                }
            }
            else {
                hexagonGC = 0
